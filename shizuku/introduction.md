...
4. (Pie+) Execute the native program `cmd` ([see here](https://aadb shell /data/app/~~m2L9tSnbLnkZj1CSYikyVQ==/moe.shizuku.privileged.api-h73oxGElSSOCv3ybuni61w==/lib/arm64/libshizuku.sondroid.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
